...
export const VERSION_HISTORY = [
  {
    ...
    date: '2025-01-15',
    changes: [
      'Fix visualizzazione versione (era "valpha" invece di "alpha")',
    ],
  },
  {
    ...
    date: '2025-01-15',
    changes: [
      'Richiesta permesso notifiche quando si attiva il toggle',
      'Mostra toast di conferma quando le notifiche sono attivate',
    ],
  },
  {
    ...
    date: '2025-01-15',
    changes: [
      'Fix toggle button - ora funziona correttamente',
      'Notifiche push browser quando altri utenti modificano',
    ],
  },
  {
  ...
  },
  {
    ...
    date: '2025-01-15',
    changes: [
      'Fix modalità compatta: ora mostra solo nome prodotto',
      'Modalità normale: immagini grandi, peso e note visibili',
    ],
  },
  {
